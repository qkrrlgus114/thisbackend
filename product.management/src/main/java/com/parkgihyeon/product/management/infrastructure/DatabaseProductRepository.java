...
public class DatabaseProductRepository implements ProductRepository {
    ...
    public Product add(Product product){
        ...
        namedParameterJdbcTemplate.update("INSERT INTO products(name, price, amount) VALUE(:name, :price, :amount)",
    ...
    public Product findById(Long id){
        ...
        try{
            product = namedParameterJdbcTemplate.queryForObject("SELECT id, name, price, amount FROM products WHERE id=:id",
